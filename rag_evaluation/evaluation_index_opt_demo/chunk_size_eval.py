...
'''
chunk_size = 512：
{'faithfulness': 0.8889, 'answer_relevancy': 0.7003,
'context_recall': 0.9167, 'context_precision': 0.6167}  ，
f1分数： 0.7373

chunk_size = 1024 ：
{'faithfulness': 0.8746, 'answer_relevancy': 0.7024,
'context_recall': 0.9167, 'context_precision': 0.6587}  ，
f1分数： 0.7666

chunk_size = 256：
{'faithfulness': 0.7756, 'answer_relevancy': 0.7117,
'context_recall': 0.5833, 'context_precision': 0.5208}  ，
f1分数： 0.5503

chunk_size = 128 ：
{'faithfulness': 0.8807, 'answer_relevancy': 0.6593, 
'context_recall': 0.8889, 'context_precision': 0.1111}  ，
f1分数： 0.1975
'''
...
# =============== 【方法2：使用ConfigurableRAGEvaluator】 ===============
print("=============== 【方法2：使用ConfigurableRAGEvaluator】=============== ")
# 批量实验不同配置
configs = [
    # {"chunk_size": 512},
    # {"chunk_size": 1024},
